...
#define PRODUCT "LamBaar" /* 硬件名词，用于蓝牙显示 */
...
#define RGB_MATRIX_CENTER { 90, 90 }
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {14, 12, 28};
static const uint8_t column_pin_array[MATRIX_COLS] = {5, 6, 15};
